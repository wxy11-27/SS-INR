...
def build_datasets1(img=None, size=None, n_select_bands=None, scale_ratio=None):
...
def build_datasets2(img=None, size=None, n_select_bands=None, scale_ratio=None):
    img=img.squeeze(0).permute(1,2,0).cpu().detach().numpy()
